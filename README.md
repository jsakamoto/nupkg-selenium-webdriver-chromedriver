...
[![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v141-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/141.0.7390.12200) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v142-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/142.0.7444.16200) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v143-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/143.0.7499.1700-beta)
...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 143.0.7499.1700-beta
```

If you are using Chrome version 142:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 142.0.7444.16200
```

If you are using Chrome version 141:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 141.0.7390.12200
```
