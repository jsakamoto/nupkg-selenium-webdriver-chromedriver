...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 137.0.7151.1500-beta
```

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 136.0.7103.9200
```
