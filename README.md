...
[![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v130-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/130.0.6723.11600) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v131-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/131.0.6778.20400) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v132-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/132.0.6834.4600-beta)
...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 132.0.6834.4600-beta
```

If you are using Chrome version 131:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 131.0.6778.20400
```
