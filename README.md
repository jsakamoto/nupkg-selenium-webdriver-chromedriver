...
[![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v147-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/147.0.7727.11700) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v148-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/148.0.7778.16700) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v149-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/149.0.7827.1400-beta)
...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 149.0.7827.1400-beta
```

If you are using Chrome version 148:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 148.0.7778.16700
```
