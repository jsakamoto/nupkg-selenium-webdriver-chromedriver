...
[![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v137-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/137.0.7151.11900) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v138-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/138.0.7204.16800) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v139-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/139.0.7258.5200-beta)
...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 139.0.7258.5200-beta
```

If you are using Chrome version 138:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 138.0.7204.16800
```
