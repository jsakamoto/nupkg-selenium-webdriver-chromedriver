...
[![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v142-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/142.0.7444.17500) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v143-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/143.0.7499.14600) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v144-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/144.0.7559.3100-beta)
...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 144.0.7559.3100-beta
```

If you are using Chrome version 143:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 143.0.7499.14600
```

If you are using Chrome version 142:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 142.0.7444.17500
```
