...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 146.0.7680-beta
```

If you are using Chrome version 145:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 145.0.7632.4600
```
