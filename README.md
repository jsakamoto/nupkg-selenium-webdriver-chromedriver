...
[![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v148-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/148.0.7778.17800) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v149-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/149.0.7827.11500) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v150-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/150.0.7871.1300-beta)
...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 150.0.7871.1300-beta
```

If you are using Chrome version 149:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 149.0.7827.11500
```
