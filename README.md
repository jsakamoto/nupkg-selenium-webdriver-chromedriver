...
If you are using Chrome version 123:
    ...
    PM> Install-Package Selenium.WebDriver.ChromeDriver -Version 123.0.6312.400-beta

If you are using Chrome version 122:

    PM> Install-Package Selenium.WebDriver.ChromeDriver -Version 122.0.6261.6901
