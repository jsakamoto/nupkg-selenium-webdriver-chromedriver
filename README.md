...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 136.0.7103.1700-beta
```

If you are using Chrome version 135:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 135.0.7049.8400
```
