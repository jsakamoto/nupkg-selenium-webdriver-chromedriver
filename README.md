...
[![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v140-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/140.0.7339.20700) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v141-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/141.0.7390.7800) [![NuGet Package](https://img.shields.io/badge/nuget-for%20Chrome%20v142-blue.svg)](https://www.nuget.org/packages/Selenium.WebDriver.ChromeDriver/142.0.7444.2300-beta)
...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 142.0.7444.2300-beta
```

If you are using Chrome version 141:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 141.0.7390.7800
```
