...
```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 151.0.7922.4700-beta
```

If you are using Chrome version 150:

```shell
dotnet add package Selenium.WebDriver.ChromeDriver --version 150.0.7871.12400
```
